...
export interface FatmaBio {
  ...
  memorialPlaqueFa: string;
  memorialPlaqueTr: string;
...
export const FATMA_BIOGRAPHY: FatmaBio = {
  ...
  nameFa: 'دکتر فاطمه القاوقجی',
  nameTr: 'Dr. Fatma Alkawokgy',
  ...
  titleFa: 'پیانیست کلاسیک، استاد دانشگاه و راوی میراث آشپزی مصر',
  titleTr: 'Klasik Piyanist, Akademisyen ve Mısır Mutfak Mirasının Kaydedicisi',
  ...
  taglineFa: 'دهه‌ها تلاش برای ثبت رازهای اصیل آشپزی سنتی مصر، با دقتی موسیقایی و گرمایی ماندگار',
  taglineTr: 'Mısır geleneksel mutfağının özgün sırlarını müzikal bir titizlik ve kalıcı bir sıcaklıkla kayda geçirmeye adanmış onlarca yıl',
  ...
  philosophyFa: 'آشپزی بسیار شبیه نواختن پیانو است: هیچ آکوردی بدون توازن هماهنگ کامل نمی‌شود، و هیچ غذایی بدون ریتم، آتش صبور و وفاداری به مواد اولیه ناب به روح واقعی خود نمی‌رسد.',
  philosophyTr: 'Yemek yapmak piyano çalmaya çok benzer: Hiçbir akor uyumlu bir denge olmadan tamamlanmaz ve hiçbir yemek ritim, sabırlı bir ateş ve saf malzemelere bağlılık olmadan gerçek ruhuna ulaşamaz.',
  ...
  memorialPlaqueFa: 'تقدیم به یاد جاودانه دکتر فاطمه القاوقجی (1943–2026). هنرمندی استثنایی که اوج‌های والای پیانوی کلاسیک را به گرمای بی‌زمان آشپزخانه مصری پیوند زد. این کتاب آشپزی زنده، میراث سخاوتمندانه او را برای همیشه زنده نگه می‌دارد.',
  memorialPlaqueTr: 'Dr. Fatma Alkawokgy’nin (1943–2026) ölümsüz anısına ithaf edilmiştir. Klasik piyanonun yüce doruklarını Mısır mutfağının zamansız sıcaklığıyla buluşturan olağanüstü bir sanatçı. Bu yaşayan yemek kitabı, onun cömert mirasını sonsuza dek yaşatacaktır.',
  ...
  biographyFa: [
    'دکتر فاطمه القاوقجی در سال 1943 در مصر به دنیا آمد؛ در روزگاری که دانش گران‌بهای آشپزخانه‌های مصری سینه‌به‌سینه از مادربزرگ‌ها به مادران منتقل می‌شد.',
    'در حدود 18 سالگی (حدود سال 1961) وارد دانشکده معتبر آموزش موسیقی در زمالک قاهره شد. در آنجا تحصیل کرد، دکترای پیانوی کلاسیک گرفت و تا پایان دوران دانشگاهی‌اش در سال 1980 به نسل‌هایی از هنرمندان و نوازندگان جوان آموزش داد و انضباط سخت هنری را با حساسیت عمیق فرهنگی درآمیخت.',
    'دکتر فاطمه در کنار دستاوردهای موسیقایی‌اش، عمر خود را وقف یک رسالت کرد: ثبت دقیق، آزمودن، مقایسه و کامل کردن صدها دستور آشپزی مصری. او با آشپزهای چیره‌دست گفت‌وگو می‌کرد، مواد را گرم‌به‌گرم وزن می‌کرد، گونه‌های مختلف را روی شعله می‌آزمود و تفاوت‌های ظریف میان دستورهای مناطق گوناگون را یادداشت می‌کرد.',
    'یادداشت‌های دست‌نویس او هسته اصلی این آرشیو دیجیتال را تشکیل می‌دهند — که اکنون با دانش نوین آشپزی و دسترسی چندزبانه حفظ شده است.',
    'دکتر فاطمه در 8 مه 2026 درگذشت. این کتاب آشپزی تعاملی یادمانی همیشگی از سخاوت، دقت علمی و عشق بی‌پایان او به فرهنگ مصر است.'
  ],
  biographyTr: [
    'Dr. Fatma Alkawokgy, Mısır mutfaklarının değerli bilgisinin büyükannelerden annelere sözlü olarak aktarıldığı bir dönemde, 1943 yılında Mısır’da doğdu.',
    'Yaklaşık 18 yaşındayken (1961 civarında) Kahire’nin Zamalek semtindeki saygın Müzik Eğitimi Fakültesi’ne girdi. Orada okudu, klasik piyano alanında doktorasını aldı ve 1980’de akademik kariyerini tamamlayana dek sayısız sanatçı ve müzisyen adayı yetiştirdi; sıkı bir sanatsal disiplini derin bir kültürel duyarlılıkla birleştirdi.',
    'Müzikteki başarılarının yanı sıra Dr. Fatma ömrünü bir amaca adadı: yüzlerce Mısır yemeği tarifini titizlikle kaydetmek, denemek, karşılaştırmak ve mükemmelleştirmek. Usta aşçılarla görüştü, malzemeleri gramına kadar tarttı, farklı varyasyonları ateşte denedi ve bölgesel hazırlıklar arasındaki ince farkları not etti.',
    'El yazısı notları bu dijital arşivin temelini oluşturuyor — artık modern mutfak bilimi ve çok dilli erişimle korunuyor.',
    'Dr. Fatma 8 Mayıs 2026’da hayata veda etti. Bu etkileşimli yemek kitabı, onun cömertliğinin, entelektüel titizliğinin ve Mısır kültürüne duyduğu sınırsız sevginin kalıcı bir anıtıdır.'
  ],
  biographyKu: [
    'Dr. Fatma Alkawokgy di sala 1943an de li Misrê hat dinê, di serdemekê de ku zanîna hêja ya metbexên Misrê bi devkî ji dapîran derbasî dayikan dibû.',
    'Dema nêzîkî 18 salî bû (derdora 1961ê), ket Fakulteya Perwerdeya Mûzîkê ya navdar li taxa Zamalek a Qahîreyê. Li wir xwend, doktoraya xwe di piyanoya klasîk de wergirt û heta ku di 1980ê de kariyera xwe ya akademîk temam kir, gelek hunermend û mûzîkjenên ciwan perwerde kirin; dîsîplîneke hunerî ya hişk bi hestiyariyeke çandî ya kûr re kir yek.',
    'Ji bilî serkeftinên xwe yên mûzîkî, Dr. Fatma temenê xwe ji bo armancekê terxan kir: bi sedan reçeteyên Misrî bi hûrbînî tomar bike, biceribîne, berhev bike û bêkêmasî bike. Bi aşpêjên jêhatî re hevdîtin kir, pêkhate heta gramê dawî pîvan, guhertoyên cuda li ser agir ceribandin û cudahiyên hûr ên navbera amadekirinên herêmî nivîsandin.',
    'Notên wê yên bi destnivîs bingeha vê arşîva dîjîtal pêk tînin — niha bi zanista metbexê ya nûjen û gihîştina pirzimanî tên parastin.',
    'Dr. Fatma di 8ê Gulana 2026an de koça dawî kir. Ev pirtûka xwarinê ya înteraktîf abîdeyeke mayînde ye ji bo comerdî, hûrbîniya rewşenbîrî û hezkirina wê ya bêsînor ji bo çanda Misrê.'
  ],
  biographyId: [
    'Dr. Fatma Alkawokgy lahir di Mesir pada tahun 1943, pada masa ketika pengetahuan berharga dapur-dapur Mesir diwariskan secara lisan dari nenek kepada ibu.',
    'Pada usia sekitar 18 tahun (sekitar 1961), ia masuk Fakultas Pendidikan Musik yang bergengsi di kawasan Zamalek, Kairo. Di sana ia belajar, meraih gelar doktor dalam piano klasik, dan membimbing banyak calon seniman dan musisi hingga menyelesaikan karier akademisnya pada tahun 1980, memadukan disiplin seni yang ketat dengan kepekaan budaya yang mendalam.',
    'Selain pencapaiannya di bidang musik, Dr. Fatma mengabdikan hidupnya untuk satu tujuan: mendokumentasikan, menguji, membandingkan, dan menyempurnakan ratusan resep Mesir dengan cermat. Ia berbincang dengan para juru masak ahli, menimbang bahan hingga gram terakhir, menguji berbagai variasi di atas api, dan mencatat perbedaan halus di antara olahan dari berbagai daerah.',
    'Catatan tulisan tangannya menjadi dasar arsip digital ini — kini dilestarikan dengan ilmu kuliner modern dan akses multibahasa.',
    'Dr. Fatma berpulang pada 8 Mei 2026. Buku resep interaktif ini adalah monumen abadi bagi kemurahan hatinya, ketelitian intelektualnya, dan cintanya yang tak terbatas pada budaya Mesir.'
  ],
  biographySw: [
    'Dkt. Fatma Alkawokgy alizaliwa Misri mwaka 1943, wakati ambapo ujuzi wa thamani wa jikoni za Kimisri ulirithishwa kwa mdomo kutoka kwa bibi hadi kwa mama.',
    'Akiwa na umri wa takriban miaka 18 (karibu 1961), alijiunga na Kitivo maarufu cha Elimu ya Muziki katika mtaa wa Zamalek jijini Kairo. Huko alisoma, akapata shahada ya uzamivu katika piano ya kiklasiki, na akawafundisha wasanii na wanamuziki wengi chipukizi hadi alipomaliza kazi yake ya kitaaluma mwaka 1980, akiunganisha nidhamu kali ya kisanaa na usikivu wa kina wa kitamaduni.',
    'Mbali na mafanikio yake ya kimuziki, Dkt. Fatma alijitolea maisha yake kwa lengo moja: kurekodi, kujaribu, kulinganisha na kukamilisha mamia ya mapishi ya Kimisri kwa umakini mkubwa. Alizungumza na wapishi mahiri, alipima viungo hadi gramu ya mwisho, alijaribu aina mbalimbali motoni, na aliandika tofauti ndogo kati ya maandalizi ya maeneo mbalimbali.',
  ...
  milestones: [
    {
      ...
      titleFa: 'تولد و ریشه‌های نخستین',
      titleTr: 'Doğum ve İlk Kökler',
    ...
    },
    {
      ...
      titleFa: 'ورود به دانشکده موسیقی زمالک (حدود 18 سالگی)',
      titleTr: 'Zamalek Müzik Fakültesi’ne Giriş (~18 Yaşında)',
    ...
    },
    {
      ...
      titleFa: 'پایان دوران دانشگاهی در زمالک',
      titleTr: 'Zamalek’teki Akademik Kariyerin Sonu',
    ...
    },
    {
      ...
      titleFa: 'دهه‌ها پژوهش میدانی در آشپزی',
      titleTr: 'Onlarca Yıllık Mutfak Araştırması',
    ...
    },
    {
      ...
      titleFa: 'درگذشت و میراث جاودان',
      titleTr: 'Vefat ve Kalıcı Miras',
      ...
      descFa: 'در 8 مه 2026 درگذشت و میراثی هنری، آشپزی و انسانی از خود به جا گذاشت که برای همیشه ماندگار خواهد بود.',
