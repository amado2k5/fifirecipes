...
// for each recipe; see recipeEstimates.ts for how the values were derived.
// Only the build script reads this table: it copies each recipe's estimate
// into that recipe's data file so the browser never downloads the whole table.
