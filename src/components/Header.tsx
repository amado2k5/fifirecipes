        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between py-3.5 border-b border-stone-100 gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              title={t('مشاركة الموقع', 'Share this site', 'Partager ce site', 'Compartir este sitio', 'このサイトをシェア', 'इस साइट को शेयर करें')}
            >
              <Share2 className="w-3.5 h-3.5 text-amber-700" />
              <span className="hidden sm:inline">{t('مشاركة الموقع', 'Share site', 'Partager le site', 'Compartir sitio', 'サイトをシェア', 'साइट शेयर करें')}</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2.5 py-2.5 text-stone-700 text-xs">
          ...
          >
            ...
            <div>
              ...
              <span className="text-stone-500 text-[11px] ml-1">{t('وصفة موحدة', 'Recipes', 'Recettes', 'Recetas', 'レシピ', 'व्यंजन')}</span>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <span className="text-stone-500 text-[11px] ml-1">{t('مكون رئيسي', 'Ingredients', 'Ingrédients', 'Ingredientes', '食材', 'सामग्री')}</span>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <span className="font-bold text-stone-900">20 {t('عاماً', 'Years', 'Ans', 'Años', '年', 'वर्ष')}</span>
              <span className="text-stone-500 text-[11px] ml-1">{t('جمع وتدوين', 'Collection', 'Collecte', 'Recopilación', '記録収集', 'संकलन')}</span>
            </div>
          </div>
        </div>
